  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"><h4 clas="font-weight-bold">Data Keikutsertaan 2019</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Rekap Data Keikutsertaan</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                $sql = $connect->query("SELECT * FROM pelatihan_pegawai");
                while ($data = $sql->fetch_array()) {
                  ...
                  <td>'.$data['bidang'].'</td>
                  <td>                  
                    <input type="button" value="View" class="btn btn-primary btn-sm"> 
